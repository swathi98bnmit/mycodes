<%-- 
    Document   : attendanceentry
    Created on : Oct 9, 2018, 12:33:08 PM
    Author     : LogicMind-1
--%>
...
<style type="text/css">
    ...
    <body>
       ...
       Class.forName("oracle.jdbc.driver.OracleDriver");        
        ...
        String sqlQuery = "insert into EMP_ATTENDANCE values("+id+",'"+name+"','"+date+"','"+absent+"','"+intime+"','"+outtime+"','"+shiftcode+"','"+empdept+"')";
